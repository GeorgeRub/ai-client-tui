...
const MODEL_OLLAMA: &str = "gemma3:4b"; // sh: `ollama pull gemma:2b`
...
async fn main()  -> Result<(), Box<dyn std::error::Error>> {
    ...
    let chat_req = ChatRequest::new(vec![
        ...
        ChatMessage::system("Answer in one sentence and russian language"),
    ...
    for (model, env_name) in MODEL_AND_KEY_ENV_NAME_LIST {
        ...
        let _adapter_kind = client.resolve_service_target(model).await?.model.adapter_kind;
